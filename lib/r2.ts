...
export const uploadProductReviewImageToR2 = async (
  productId: string,
  variantId: string,
  file: Buffer | Uint8Array | Blob | string,
  mimeType: string,
  ...
  try {
    ...
    const key = `product-reviews/${productId}/${variantId}/${fileName}`;
...
export const uploadBrandImageToR2 = async (
  file: Buffer | Uint8Array | Blob | string,
  mimeType: string,
  fileName: string
) => {
