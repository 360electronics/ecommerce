...
const Header = () => {
    ...
    return (
        <header
            className={`w-full bg-white py-3 px-4 md:px-12 fixed top-0 left-0 z-50 transition-all duration-300 ${isScrolled ? 'shadow-md' : ''
                }`}
        >
                ...
                >
                    <div className="p-4 flex flex-col h-full">
                        ...
                        <div className="py-4 border-b border-gray-200">
                            ...
                            {['Laptops', 'Desktops', 'Components', 'Peripherals', 'Accessories'].map((category) => (
                                <Link
