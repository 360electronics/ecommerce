...
export default function HeroBanner() {
    ...
    return (
        <div className="w-full flex flex-col gap-3 items-center justify-center p0">
            <div className="relative w-full h-[70dvh]">
                    ...
                    <div className="relative w-full h-full">
                        ...
                        <div className="absolute inset-0 flex items-center justify-between px-4">
                            <button
                                ...
                                className="bg-black cursor-pointer bg-opacity-30 hover:bg-opacity-50 text-white p-2 rounded-full"
                            >
                ...
                <div className="absolute left-0 bottom-0 w-[30%] md:w-[20%] h-[30%] border-t-[10px] border-r-[10px] border-white rounded-tr-xl rounded-bl-xl overflow-hidden">
                    ...
                    <div className="relative w-full h-full">
                        ...
                        <button
                            onClick={toggleMute}
                            className=" cursor-pointer absolute bottom-2 right-2 z-50 bg-slate-50 text-black p-1 rounded-full shadow-md hover:bg-gray-200 transition"
                        >
