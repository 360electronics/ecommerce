...
const ScrollStack = ({
  ...
  const handleScroll = useCallback(() => {
    ...
    const contentEl = scroller.querySelector('.scroll-stack-inner') as HTMLElement;
  ...
  return (
    <div
      className={`relative w-full h-full no-scrollbar overflow-y-auto overflow-x-visible ${className}`.trim()}
      ref={scrollerRef}
      style={{ 
